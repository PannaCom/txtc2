...
private extension ColorTabs {
    ...
    func moveHighlighterView(toItemAt toIndex: Int) {
        ...
        highlighterView.frame.size.width = toIndex == 0 ? 260 : toLabel.bounds.width + (toLabel.frame.origin.x - toIcon.frame.origin.x) + 10 - offsetForFirstItem + offsetForLastItem
